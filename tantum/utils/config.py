...
def create_parser():
    ...
    parser.add_argument('--num-labels', default=4000, type=int, metavar='N', help='number of labeled samples')
    ...
    # Data pre-processing
    parser.add_argument('--data-twice', default=True, type=str2bool, metavar='BOOL', help='use two data stream (default: False)')
    ...
    # Architecture
    parser.add_argument('--arch',  '-a', default='resnet18', metavar='ARCH')
    parser.add_argument('--model', default='mtv2', metavar='MODEL')
    parser.add_argument('--drop-ratio', default=0., type=float, help='ratio of dropout (default: 0)')

    # Optimization
    parser.add_argument('--epochs', default=100, type=int, metavar='N', help='number of total training epochs')
    ...
    parser.add_argument('--ema-decay', default=0.97, type=float, metavar='W', help='ema weight decay')
